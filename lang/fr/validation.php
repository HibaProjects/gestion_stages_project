...
/*
|--------------------------------------------------------------------------
| Messages de langue de validation
|--------------------------------------------------------------------------
|
| Les lignes de langue suivantes contiennent les messages d'erreur par défaut
| utilisés par la classe de validateur. Certaines de ces règles ont des
| versions multiples, telles que les règles de taille. N'hésitez pas
...
*/
    ...
    'missing_unless' => 'Le champ :attribute est requis à moins que :other ne soit :value.',
    'missing_with' => 'Le champ :attribute est requis lorsque :values est présent.',
    'missing_with_all' => 'Le champ :attribute est requis lorsque :values sont présents.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer nos
    | espaces réservés d'attributs par quelque chose de plus convivial
    | pour le lecteur, comme "Adresse e-mail" au lieu de "email".
